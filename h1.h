...
class Student:public Person
{
    ...
    public:
        Student(string a="empty",string b="empty",string c="empty",string d="empty")
		{
           fName=a;
           lName=b;
           stdNumber=c;
    ...
    private:
        void setStudents()
		{
            ...
            for(int i=0;i<size;i++)
			{
                ...
                cin>>callNumber;
                students[i]=Student(fName,lName,stdNumber,callNumber);
            }
        }
...
class Morabi:public Person
{
    public:
        ...
        Team createTeam()
		{
            ...
            outputFile.close();
            cout<<"sport code:\n"<<"code fotball=Q1;code valibal=Q2;code tenis=Q3:\n";
            cin>>sportCode;
            inTeam=true;
